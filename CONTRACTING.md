# CONTRACTING.md — Fractional/Interim Engagement Playbook (living doc)

Purpose: build a personal playbook for operating as a fractional/interim VP
of Product — what to do/not do across the full lifecycle of an engagement
(marketing → qualifying → interviewing → during → ending → running
multiple concurrently), plus open scenarios still worth researching.
Complements `OUTREACH.md` (how to *get* the conversation) — this file is
about what to do once you're in one or actually working.

## How to use this file
- Each section below has a **Status** and **Last researched** date.
  "Seeded" = brainstormed/logical but not yet backed by real research.
  "Researched" = has actual sourced findings.
- Revisit monthly: check each section's Last-researched date: if it's
  30+ days old, it's a candidate for the next research pass (see To Do).
- Sources are logged once in the Sources Reviewed table — don't
  re-search the same source for the same section; do check it again if a
  section is being revisited after months (content may have updated).
...
**Do:**
- Cap committed bandwidth — don't let one engagement consume more than
  ~60% of capacity; keep room for a second client and business-dev.
- Insist on a real scope, not a title. "Help with growth" isn't a scope —
  push for specific outcomes, measurable goals, a timeframe. Vague
  scoping is the most-cited first-engagement failure mode.
- Insist on real authority (sign-off on OKRs/roadmap), not just advisory
  access — fits his stated differentiator (execution over
  strategy-writing); "advice only" engagements set him up to be blamed
  for outcomes he can't actually drive.
- Build in a coaching/succession mandate — fractional engagements often
  include growing the eventual full-time head of product; reduces client
  risk and is worth naming explicitly in the pitch.
- Design deliberate visibility/trust-building early (intros, structured
  presence) rather than being "hidden" from the org — integration
  failure is the most-cited reason engagements underperform.
- Japan-specific: decision cycles run long — the differentiator is
  speed/precision *within* that cycle, not fighting it (per a cited
  Tokyo interim-CFO case).

**Don't:**
- Don't accept engagements with vague scope or advisory-only authority.
- Don't skip explicit onboarding/authority setup assuming it'll "sort
  itself out" — it doesn't.
- Don't let a client treat part-time as "less committed" — stay visibly
  accountable, not "just temporary."
- Avoid reactive feature/priority churn without a testing plan —
  undermines the "operator with judgment" positioning.

**Rate context found:** fractional VP of Product roles commonly run
$5,000–12,000/month or $100–250/hr in current market data — roughly in
...
Candidate scenarios/sections not yet decided as worth their own section
— revisit and promote to full sections as they become relevant:
- Rate renegotiation mid-engagement or at renewal
- Early exit from a bad-fit engagement — how to do it cleanly
- Working through an agency/platform vs. direct client relationship —
  does the playbook change
- Remote vs. on-site expectations, and how that's usually negotiated
- IP/confidentiality handling across concurrent clients (ties to
  section 7's conflict-of-interest question)

---

## Sources Reviewed
*Log every source used per section, so future passes don't re-review the
same ones for the same section (do re-check if the section is being
revisited months later — content may have updated).*

| Date | Section(s) | Source | Key takeaway used |
|---|---|---|---|
| 2026-07-21 | 1 | [The Ultimate Guide to Fractional Product Leadership](https://oneknightinproduct.substack.com/p/the-ultimate-guide-to-fractional) | Bandwidth cap, coaching/succession mandate |
| 2026-07-21 | 1 | [Fractional Chief Product Officer Playbook](https://umbrex.com/resources/fractional-executive-playbook/fractional-chief-product-officer-playbook/) | Owns outcomes vs. advises from sidelines; rate ranges |
| 2026-07-21 | 1 | [Six steps to success in an interim role](https://chatsworthconsulting.com/2021/10/01/six-steps-to-success-in-an-interim-role/) | Clarify expectations upfront, accountability despite "temporary" status |
| 2026-07-21 | 1 | [Filling the Gap: Five Critical Factors to Ensure Interim Executive Success](https://mdaleadership.com/filling-the-gap-five-critical-factors-to-ensure-interim-executive-success/) | Capacity assessment, careful change management as an outsider |
